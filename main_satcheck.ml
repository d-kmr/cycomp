...
;;
 *)
let set_debug () = Options.Satchecker.o.debug <- true
let set_model () = Options.Satchecker.o.model <- true                 
...
let speclist = [
    ...
    ("-model", Arg.Unit set_model, "Model create mode");
];;
